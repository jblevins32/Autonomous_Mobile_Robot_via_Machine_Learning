"""
This module defines the interface for the ROS node classes used in this project.
This interface implements convenient methods for initializing member variables, ROS parameters, publishers, subscribers, and timers.
It's basically used as "training wheels" for new ROS users.
"""
import abc
